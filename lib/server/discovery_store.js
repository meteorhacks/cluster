DiscoveryStore = function DiscoveryStore() {
...
DiscoveryStore.prototype.set = function set(id, service) {
  service._id = id;
...
DiscoveryStore.prototype.get = function get(id) {
  return this._allEndpoints[id];
};

DiscoveryStore.prototype.remove = function remove(id) {
...
DiscoveryStore.prototype.getAll = function getAll(serviceName) {
  this._ensureStore(serviceName);
  if(serviceName) {
...
DiscoveryStore.prototype.getRandom = function getRandom(serviceName) {
...
DiscoveryStore.prototype.getRandomWeighted =
...
DiscoveryStore.prototype.byEndpointHash = function byEndpointHash(hash) {
  return this._allEndpointsByEndpointHash[hash];
};

DiscoveryStore.prototype.byBalancer = function(balancer) {
  return this._allEndpointsByBalancer[balancer];
};

DiscoveryStore.prototype._ensureStore =
